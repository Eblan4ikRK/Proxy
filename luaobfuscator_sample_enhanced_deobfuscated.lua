-- Enhanced LuaObfuscator.com Deobfuscated Script
-- Deobfuscated using v28 function analysis
-- Original: Alpha 0.10.9
...
-- To extract actual runtime values, inject this debug code:
--[[
...
-- Reconstructed functionality:

-- Simplified equivalent based on analysis:
print("hello")